...
import com.example.traveldemo.databinding.ActivityVerifyPhoneNumberBinding;
...
public class VerifyPhoneNumberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_verify_phone_number);
        mAuth = FirebaseAuth.getInstance();
        binding.btnVerifyPhoneNumber.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String strPhone = binding.edPhoneNumber.getText().toString().trim();
